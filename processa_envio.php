<?php 
    ...
    try {
        ...
        $mail->Password   = '***********'; //SMTP                              //SMTP password
        ...
        $mail->AltBody = 'É necessario utilizar um client que suporte HTML para acesso total ao conteudo dessa mensagem';
        ...
        $mensagem->status['descricao_status'] = 'Não foi possivel enviar esse E-mail' . $mail->ErrorInfo;
